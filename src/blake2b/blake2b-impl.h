...
#ifndef _HS_BLAKE2B_IMPL_H
#define _HS_BLAKE2B_IMPL_H
...
#include <string.h>
  ...
  #if defined(_MSC_VER)
    #define HS_BLAKE2B_INLINE __inline
  #elif defined(__GNUC__)
    #define HS_BLAKE2B_INLINE __inline__
  #else
    #define HS_BLAKE2B_INLINE
  #endif
#else
  #define HS_BLAKE2B_INLINE inline
#endif

static HS_BLAKE2B_INLINE
